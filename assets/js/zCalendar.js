	...
	var _calView = (function($) {
		...
		function changeMonth(date) {
			...
			$(".zcalendar-item").each(function() {
				...
				var nowDate_Month = new Date()
				nowDate_Month.setHours(0,0,0,0)
				if(d.getTime() == nowDate_Month.getTime()) {
					this.classList.add('nowdate');
				}
			});
		}
		...
		function changeTag(date, str) {
			...
			if(dom) {
				dom.querySelector('.zcalendar-tag').innerHTML = str;
